import { FaDiscord, FaGithub, FaLinkedinIn, FaSteam, FaTwitter } from "react-icons/fa";
...
const socials = [
    ...
    {
        name: "Steam",
        url: "https://steamcommunity.com/id/thedaxer",
    ...
    return (
        <div className="w-full flex flex-col gap-1 h-78 overflow-y-scroll contact-scroll rounded-2xl  text-black p-5 border border-white/10 bg-black/15 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.25)]">
            ...
            {socials.map(social => (
                ...
                >
                    <div className="flex items-center bg-white/9 p-2 rounded-md">{social.icon}</div>
